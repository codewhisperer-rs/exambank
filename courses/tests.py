...
# 测试环境中不应使用真实API密钥，使用环境变量或设置假密钥
TEST_GROK_API_KEY = os.environ.get('TEST_GROK_API_KEY', 'xai-O3QdRmxwS48SZJGgp646FnBoFyum2liAKZTEim1frYcTf8Uv6BuNcDsjLbgDGIIPlrQhotNKKGzCs8qQ')
TEST_DEEPSEEK_API_KEY = os.environ.get('TEST_DEEPSEEK_API_KEY', 'sk-f2d0085bbb88479b9b0d7b1f2451b310')
